...
fn get_token_category_from_value(value: &str) -> Option<TokenCategory> {
    return match value {
        ...
        "BIT_LENGTH" => Some(TokenCategory::Function),
        "CHARACTER_LENGTH" => Some(TokenCategory::Function),
        "CHAR_LENGTH" => Some(TokenCategory::Function),
        "COALESCE" => Some(TokenCategory::Function),
        "DATALENGTH" => Some(TokenCategory::Function),
