...
impl Token {
    ...
    fn get_category(&self) -> Option<TokenCategory> {
        ...
        return match self.value.to_uppercase().as_str() {
            ...
            "BIGINT" => Some(TokenCategory::Keyword),
            "BIN" => Some(TokenCategory::Keyword),
            "BINARY" => Some(TokenCategory::Keyword),
            "BIT" => Some(TokenCategory::Keyword),
            "BIT_LENGTH" => Some(TokenCategory::Keyword),
            "BLOB" => Some(TokenCategory::Keyword),
            "BOOL" => Some(TokenCategory::Keyword),
            "BOOLEAN" => Some(TokenCategory::Keyword),
            ...
            "CHAR" => Some(TokenCategory::Keyword),
            ...
            "DATE" => Some(TokenCategory::Keyword),
            ...
            "DATETIME" => Some(TokenCategory::Keyword),
            "DATETIME2" => Some(TokenCategory::Keyword),
            "DATETIMEOFFSET" => Some(TokenCategory::Keyword),
            ...
            "DEC" => Some(TokenCategory::Keyword),
            "DECFLOAT" => Some(TokenCategory::Keyword),
            "DECIMAL" => Some(TokenCategory::Keyword),
            ...
            "DOUBLE" => Some(TokenCategory::Keyword),
            ...
            "ENUM" => Some(TokenCategory::Keyword),
            ...
            "FIRST" => Some(TokenCategory::Keyword),
            "FIRST_VALUE" => Some(TokenCategory::Keyword),
            "FLOAT" => Some(TokenCategory::Keyword),
            ...
            "INT" => Some(TokenCategory::Keyword),
            ...
            "INTEGER" => Some(TokenCategory::Keyword),
            ...
            "LEAD" => Some(TokenCategory::Keyword),
            ...
            "LONGBLOB" => Some(TokenCategory::Keyword),
            "LONGTEXT" => Some(TokenCategory::Keyword),
            ...
            "MEDIUMBLOB" => Some(TokenCategory::Keyword),
            "MEDIUMINT" => Some(TokenCategory::Keyword),
            "MEDIUMTEXT" => Some(TokenCategory::Keyword),
            ...
            "MONEY" => Some(TokenCategory::Keyword),
            "MONITOR" => Some(TokenCategory::Keyword),
            ...
            "NCHAR" => Some(TokenCategory::Keyword),
            ...
            "NUMERIC" => Some(TokenCategory::Keyword),
            "NUMPARTS" => Some(TokenCategory::Keyword),
            "NVARCHAR" => Some(TokenCategory::Keyword),
            ...
            "REAL" => Some(TokenCategory::Keyword),
            ...
            "ROW_NUMBER" => Some(TokenCategory::Keyword),
            ...
            "SMALLDATETIME" => Some(TokenCategory::Keyword),
            "SMALLINT" => Some(TokenCategory::Keyword),
            "SMALLMONEY" => Some(TokenCategory::Keyword),
            ...
            "SQL_VARIANT" => Some(TokenCategory::Keyword),
            ...
            "TEXT" => Some(TokenCategory::Keyword),
            ...
            "TIME" => Some(TokenCategory::Keyword),
            "TIMEDIFF" => Some(TokenCategory::Keyword),
            "TIMESTAMP" => Some(TokenCategory::Keyword),
            ...
            "TINYBLOB" => Some(TokenCategory::Keyword),
            "TINYINT" => Some(TokenCategory::Keyword),
            "TINYTEXT" => Some(TokenCategory::Keyword),
            ...
            "UNIQUEIDENTIFIER" => Some(TokenCategory::Keyword),
            ...
            "VARBINARY" => Some(TokenCategory::Keyword),
            "VARBYTE" => Some(TokenCategory::Keyword),
            "VARCHAR" => Some(TokenCategory::Keyword),
            "VARCHAR2" => Some(TokenCategory::Keyword),
            "VARCHARACTER" => Some(TokenCategory::Keyword),
            ...
            "XML" => Some(TokenCategory::Keyword),
            ...
            "YEAR" => Some(TokenCategory::Keyword),
